    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!isTrue)
            {
                ...
                Console.WriteLine("4) Display a employee list");
               ...
               int lastEmployeeId = listOfEmployees[employeeCount].EmployeeId;
                ...
                switch (userInput)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Console.WriteLine($"Are you sure you want to delect Employee  ?");
