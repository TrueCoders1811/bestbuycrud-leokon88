...
namespace BestBuyCRUD
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Create new employee
            Employees employee1 = new Employees("Emily", "L", "Jones", "EJones11@gmail.com", "223-421-9903", "GeekSquad", new DateTime(1988, 01, 11, 00, 03, 20));// constructor created to create a new employee
          ...
          /*  List<Sales> sales = sr.GetSales();
            ...
            */
            ...
            //Update Employee info
             er.UpdateEmployees(lastEmployeeId,"mmmm" , "S", "Lim");
